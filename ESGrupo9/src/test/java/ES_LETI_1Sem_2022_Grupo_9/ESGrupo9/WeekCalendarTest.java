...
public class WeekCalendarTest {
	public static void main(String[] args) throws Exception {
		...
		ArrayList<String>httpsURLs = new ArrayList<>();
...
//			for(int a=0; a<events.size()-1; a++){
//				for(int b=1; b<events.size(); b++){
//					//							System.out.println("A: " + events.get(a).getStart() + "---" + events.get(a).getDate());
//					//							System.out.println("B: " + events.get(b).getStart() + "---" + events.get(b).getDate());
//					if(events.get(a).getStart()==events.get(b).getStart() && events.get(a).getDate()==events.get(b).getDate()){
//						//							System.out.println("Encontrei dois eventos sobrepostos");
//						c = new Color(164,0,0);
//						events.get(a).setColor(c);
//
//					}
//				}
//			}
